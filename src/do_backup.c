...
void do_backup(char *path) {
	...
	NOTICE("read file time: %lf", jcr.read_time);
	...
	printf("index_overhead.lookup_requests: %d\n", index_overhead.lookup_requests);
	printf("index_overhead.lookup_requests_for_unique: %d\n", index_overhead.lookup_requests_for_unique);
	printf("index_overhead.update_requests: %d\n", index_overhead.update_requests);
	printf("index_overhead.read_prefetching_units: %d\n", index_overhead.read_prefetching_units);
