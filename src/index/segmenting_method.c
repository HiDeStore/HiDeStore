...
void init_segmenting_method(){
    switch (destor.index_segment_algorithm[0]) {
        case INDEX_SEGMENT_FIXED:
            ...
            //NOTICE("init_segmenting_method: segment_fixed, segmenting_algorithm[1]: %d", destor.index_segment_algorithm[1]);
            break;
        case INDEX_SEGMENT_CONTENT_DEFINED:
            segmenting = segment_content_defined;
            NOTICE("init_segmenting_method: segment_content_defined, segmenting_algorithm[1]: %d", destor.index_segment_algorithm[1]);
            break;
        case INDEX_SEGMENT_FILE_DEFINED:
            segmenting = segment_file_defined;
            NOTICE("init_segmenting_method: segment_file_defined, segmenting_algorithm[1]: %d", destor.index_segment_algorithm[1]);
            break;
        default:
