...
void init_sampling_method(){
    switch (destor.index_sampling_method[0]) {
        case INDEX_SAMPLING_RANDOM:
            ...
            NOTICE("init_sampling_method: index_sampling_random, sampling_method[1]: %d", destor.index_sampling_method[1]);
            break;
        case INDEX_SAMPLING_OPTIMIZED_MIN:
            sampling = index_sampling_optimized_min;
            NOTICE("init_sampling_method: index_sampling_optimized_min, sampling_method[1]: %d", destor.index_sampling_method[1]);
            break;
        case INDEX_SAMPLING_MIN:
            sampling = index_sampling_min;
            NOTICE("init_sampling_method: index_sampling_min, sampling_method[1]: %d", destor.index_sampling_method[1]);
            break;
        case INDEX_SAMPLING_UNIFORM:
            sampling = index_sampling_uniform;
            //NOTICE("init_sampling_method: index_sampling_uniform, sampling_method[1]: %d", destor.index_sampling_method[1]);
            break;
        default:
